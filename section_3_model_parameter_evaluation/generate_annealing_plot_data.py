...
n_0_defect_1, n_0_defect_2, n_0_defect_3 = defect_type_1_densities[0], defect_type_2_densities[0], defect_type_3_densities[0]

annealed_defect_1_densities, annealed_defect_2_densities, annealed_defect_3_densities = [], [], []

for T in T_values:
    # defect type 1
    defect_1_extra_args = (phi, K, n_max, A_0_1, E_A_1, T)
    n_traps_annleaing_defect_1 = odeint(
        neutron_trap_creation_numerical, n_0_defect_1, t_annealing, args=defect_1_extra_args
    )
    ...
    n_traps_annleaing_defect_2 = odeint(
        neutron_trap_creation_numerical, n_0_defect_2, t_annealing, args=defect_2_extra_args
    )
    ...
    n_traps_annleaing_defect_3 = odeint(
        neutron_trap_creation_numerical, n_0_defect_3, t_annealing, args=defect_3_extra_args
    )
