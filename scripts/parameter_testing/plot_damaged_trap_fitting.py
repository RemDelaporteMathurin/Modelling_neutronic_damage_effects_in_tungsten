...
def plot_all_in_one_paper():
    ...
    plt.scatter(dpa_values, trap2, color=pewter_blue, marker="x")
    plt.plot(
        dpa_list, damaged_trap2_densities, color=pewter_blue, label=trap2_label
    )
    plt.scatter(dpa_values, trap3, color=electric_blue, marker="x")
    plt.plot(
        dpa_list, damaged_trap3_densities, color=electric_blue, label=trap3_label
    )
    plt.scatter(dpa_values, trap4, color=green_ryb, marker="x")
    plt.plot(
        dpa_list, damaged_trap4_densities, color=green_ryb, label=trap4_label
    )
